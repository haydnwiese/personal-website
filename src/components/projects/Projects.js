...
import analyzerSearch from "../../resources/projects/github_analyzer/search_screenshot.png";
import analyzerDetails1 from "../../resources/projects/github_analyzer/details_screenshot1.png";
import analyzerDetails2 from "../../resources/projects/github_analyzer/details_screenshot2.png";
...
const Projects = () => (
  <div id="projects">
    ...
    <div className="projectsContainer">
      ...
      <ProjectTile
        projectTitle="GitHub Profile Analyzer"
        projectTool="Swift"
        layout="column"
        description1="iOS app that provides an analysis of any GitHub profile"
      >
        <img className="appPreviewScreenshots" src={analyzerSearch} />
        <img className="appPreviewScreenshots" src={analyzerDetails1} />
        <img className="appPreviewScreenshots" src={analyzerDetails2} />
      </ProjectTile>
    </div>
    <div className="projectsContainer">
      <ProjectTile
